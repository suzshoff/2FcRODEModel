...
% k1r2f = 52e-6; %IgG1:Ag + type2a forward
k1r2r = 1e-2;
% k2r2f = 4.5e-6; %IgG2:Ag + type2a forward
k2r2r = 1e-2;
% k3r2f = 8.9e-6; %IgG3:Ag + type2a forward
k3r2r = 1e-2;
% k4r2f = 1.7e-6; %IgG1:Ag + type2a forward
k4r2r = 1e-2;
...
if disease == 'HIV'
    ...
    if bodycell == 'blood'
        ...
        igg4tot = 0.23;
        agtot = 2.2e-6;
        if type1 == '2aH' & type2 == '2aR'
            type2atot = (2.5e-2)/2;
            fcr3atot = (2.5e-2)/2;
        elseif type1 == '3aV' & type2 == '3aF'
            type2atot = (5.5e-2)/2;
            fcr3atot = (5.5e-2)/2;
        else
            type2atot = 2.5e-2;
...
p = [k1af k1ar k2af k2ar k3af k3ar k4af k4ar...
    ...
    igg1tot igg2tot igg3tot igg4tot agtot type2atot fcr3atot];
